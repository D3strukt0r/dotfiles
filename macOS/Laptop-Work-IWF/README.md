...
* Fix Librewolf Gatekeeper check `xattr -d com.apple.quarantine /Applications/LibreWolf.app`
* Fix Headlamp Gatekeeper check `xattr -d com.apple.quarantine /Applications/Headlamp.app`
